...
namespace Orleans.SwaggerGen
{
    public class XmlCommentsOperationFilter : IOperationFilter
    {
        ...
        {
            var memberName = XmlCommentsMemberNameHelper.GetMemberNameForMethod(context.MethodInfo);
            ...
            ApiDescription apiDescription)
        {
            ...
            foreach (var parameter in parameters)
            {
                ...
                var actionParameter = apiDescription.Parameters
            ...
            ApiDescription apiDescription)
        {
            ...
            foreach (var parameter in parameters)
            {
                ...
                var propertyParam =
                    apiDescription.Parameters
                    .FirstOrDefault(p => parameter.Name.Equals(p.Name, StringComparison.OrdinalIgnoreCase));
                if (propertyParam == null) continue;

                var memberInfo = apiDescription.MethodInfo.DeclaringType.GetMember(propertyParam.Name).FirstOrDefault();
